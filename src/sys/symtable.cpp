...
void SetupSymtable() {
	...
	KRNLSYMTABLE[KRNLSYMTABLE_BUFFERCREATE] = &MKMI_BufferCreate;
	KRNLSYMTABLE[KRNLSYMTABLE_BUFFERIOCTL] = &MKMI_BufferIO;
	KRNLSYMTABLE[KRNLSYMTABLE_BUFFERDELETE] = &MKMI_BufferDelete;
}
