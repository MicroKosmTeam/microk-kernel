...
typedef enum {
	SYSCALL_THREADCTL_REGS_READ = 1,
	SYSCALL_THREADCTL_REGS_WRITE,
} SYSCALL_THREADCTL_OPS;

typedef enum {
	NULL_SLOT = 0,
	CSPACE_SLOT,
	ROOT_CNODE_SLOT,
	THREAD_CONTROL_BLOCK_SLOT,
